...
class FavoritesScreen extends StatelessWidget {
    ...
    return BlocConsumer<AppCubit,AppStates>(
      ...
      builder: (context, state) {
        return ConditionalBuilder(
          condition: state is! GetFavoriteDataLoadingState && AppCubit.get(context).favoriteModel != null,
          builder: (context) => ListView.separated(
            physics: BouncingScrollPhysics(),
            itemBuilder: (context, index) => buildFavoriteItem(AppCubit.get(context).favoriteModel.data.data[index],context),
  ...
  Widget buildFavoriteItem(Data model,context)=> Padding(
